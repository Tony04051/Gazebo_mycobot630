...
static size_t _SetCoords_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_mycobot_pro450_interfaces__srv__SetCoords_Request(
    full_bounded, 0);
}
...
static size_t _SetCoords_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_mycobot_pro450_interfaces__srv__SetCoords_Response(
    full_bounded, 0);
}
