...
static size_t _MycobotGripperStatus__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_mycobot_pro450_interfaces__msg__MycobotGripperStatus(
    full_bounded, 0);
}
