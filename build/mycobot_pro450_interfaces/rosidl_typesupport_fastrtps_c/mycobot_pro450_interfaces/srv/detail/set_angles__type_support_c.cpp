...
static size_t _SetAngles_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_mycobot_pro450_interfaces__srv__SetAngles_Request(
    full_bounded, 0);
}
...
static size_t _SetAngles_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_mycobot_pro450_interfaces__srv__SetAngles_Response(
    full_bounded, 0);
}
