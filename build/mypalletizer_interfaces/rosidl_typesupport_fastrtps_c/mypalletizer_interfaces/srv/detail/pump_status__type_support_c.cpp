...
static size_t _PumpStatus_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_mypalletizer_interfaces__srv__PumpStatus_Request(
    full_bounded, 0);
}
...
static size_t _PumpStatus_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_mypalletizer_interfaces__srv__PumpStatus_Response(
    full_bounded, 0);
}
