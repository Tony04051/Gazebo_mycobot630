...
static rosidl_typesupport_introspection_c__MessageMember SetAngles_Request__rosidl_typesupport_introspection_c__SetAngles_Request_message_member_array[5] = {
  {
    "joint_1",  // name
