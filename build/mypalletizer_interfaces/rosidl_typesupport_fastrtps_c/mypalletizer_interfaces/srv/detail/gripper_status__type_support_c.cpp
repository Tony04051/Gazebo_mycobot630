...
{
  return max_serialized_size_mypalletizer_interfaces__srv__GripperStatus_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_mypalletizer_interfaces__srv__GripperStatus_Response(
    full_bounded, 0);
}
