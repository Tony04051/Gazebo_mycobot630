...
void SetAngles_Request__rosidl_typesupport_introspection_c__SetAngles_Request_init_function(
...
void SetAngles_Request__rosidl_typesupport_introspection_c__SetAngles_Request_fini_function(void * message_memory)
{
  mycobot_interfaces__srv__SetAngles_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember SetAngles_Request__rosidl_typesupport_introspection_c__SetAngles_Request_message_member_array[7] = {
  {
    "joint_1",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers SetAngles_Request__rosidl_typesupport_introspection_c__SetAngles_Request_message_members = {
  "mycobot_interfaces__srv",  // message namespace
  "SetAngles_Request",  // message name
  7,  // number of fields
  sizeof(mycobot_interfaces__srv__SetAngles_Request),
  SetAngles_Request__rosidl_typesupport_introspection_c__SetAngles_Request_message_member_array,  // message members
  SetAngles_Request__rosidl_typesupport_introspection_c__SetAngles_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  SetAngles_Request__rosidl_typesupport_introspection_c__SetAngles_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t SetAngles_Request__rosidl_typesupport_introspection_c__SetAngles_Request_message_type_support_handle = {
  0,
  &SetAngles_Request__rosidl_typesupport_introspection_c__SetAngles_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mycobot_interfaces, srv, SetAngles_Request)() {
  if (!SetAngles_Request__rosidl_typesupport_introspection_c__SetAngles_Request_message_type_support_handle.typesupport_identifier) {
    SetAngles_Request__rosidl_typesupport_introspection_c__SetAngles_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &SetAngles_Request__rosidl_typesupport_introspection_c__SetAngles_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void SetAngles_Response__rosidl_typesupport_introspection_c__SetAngles_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void SetAngles_Response__rosidl_typesupport_introspection_c__SetAngles_Response_fini_function(void * message_memory)
{
  mycobot_interfaces__srv__SetAngles_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember SetAngles_Response__rosidl_typesupport_introspection_c__SetAngles_Response_message_member_array[1] = {
  {
    "flag",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers SetAngles_Response__rosidl_typesupport_introspection_c__SetAngles_Response_message_members = {
  "mycobot_interfaces__srv",  // message namespace
  "SetAngles_Response",  // message name
  1,  // number of fields
  sizeof(mycobot_interfaces__srv__SetAngles_Response),
  SetAngles_Response__rosidl_typesupport_introspection_c__SetAngles_Response_message_member_array,  // message members
  SetAngles_Response__rosidl_typesupport_introspection_c__SetAngles_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  SetAngles_Response__rosidl_typesupport_introspection_c__SetAngles_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t SetAngles_Response__rosidl_typesupport_introspection_c__SetAngles_Response_message_type_support_handle = {
  0,
  &SetAngles_Response__rosidl_typesupport_introspection_c__SetAngles_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mycobot_interfaces, srv, SetAngles_Response)() {
  if (!SetAngles_Response__rosidl_typesupport_introspection_c__SetAngles_Response_message_type_support_handle.typesupport_identifier) {
    SetAngles_Response__rosidl_typesupport_introspection_c__SetAngles_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &SetAngles_Response__rosidl_typesupport_introspection_c__SetAngles_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
