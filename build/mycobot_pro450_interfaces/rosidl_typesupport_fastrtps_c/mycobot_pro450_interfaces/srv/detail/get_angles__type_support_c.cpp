...
static size_t _GetAngles_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_mycobot_pro450_interfaces__srv__GetAngles_Request(
    full_bounded, 0);
}
...
static size_t _GetAngles_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_mycobot_pro450_interfaces__srv__GetAngles_Response(
    full_bounded, 0);
}
