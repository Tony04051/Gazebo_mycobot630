...
static rosidl_typesupport_introspection_c__MessageMember SetCoords_Request__rosidl_typesupport_introspection_c__SetCoords_Request_message_member_array[8] = {
  {
    "x",  // name
